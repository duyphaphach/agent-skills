...
This project is indexed by GitNexus as **agent-skills** (292 symbols, 510 relationships, 18 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
