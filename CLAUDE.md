...
This project is indexed by GitNexus as **agent-skills** (286 symbols, 504 relationships, 18 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
