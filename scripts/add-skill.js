...
const SKILLS_DIR = join(ROOT_DIR, "packages", "skills");
...
async function main() {
  ...
  console.log(`Created packages/skills/${skillName}/SKILL.md`);
  console.log();
  ...
  console.log("\nNext steps:");
  console.log(
    `  1. Edit packages/skills/${skillName}/SKILL.md to add your skill content`
  );
  console.log(
